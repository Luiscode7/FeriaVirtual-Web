...
{
    public class ListadoSubastasPexterna
    {
        int totalColumnas = 5;
        Document document;
        Font fontStyle;
        ...
        List<ProcesoVentaViewModel> newsubasta = new List<ProcesoVentaViewModel>();

        public byte[] PdfReport(List<ProcesoVentaViewModel> subasta)
        {
            newsubasta = subasta;
        ...
        private void ReportHeader()
        {
            ...
            pdfCell = new PdfPCell(new Phrase("LISTADO DE SUBASTAS EXTERNAS", fontStyle));
        ...
        private void ReportBody()
        {
            ...
            foreach (var item in newsubasta)
            {
                fontStyle = FontFactory.GetFont("Tahoma", 9f, 0);
